        ...
        <div style={{ display: 'flex', gap: '5rem' }}>
            <div style={{ flexGrow: 3 }}>
                <Form form={form} onFinish={handleNextStep}>
                    ...
                    <Form.Item name="Phone number" label="Phone number" rules={[{ required: true, message: 'Please input your phone number!' }]} >
                        ...
                        <Form.Item name="Guests" label='Guests' style={{ display: 'inline-block', width: '8rem', marginLeft: 10 }} rules={[{ required: true}]}>
                            <InputNumber min={1} max={20} onChange={(val) => handleInput({target: {value: val} }, 'totalGuests')} />
                        </Form.Item>
                    </Form.Item>
                    <Form.Item>
